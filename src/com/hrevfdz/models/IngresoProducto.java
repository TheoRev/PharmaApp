...
@NamedQueries({
    ...
    , @NamedQuery(name = "IngresoProducto.findByCodStock", query = "SELECT i FROM IngresoProducto i WHERE i.codStock = :codStock")})
public class IngresoProducto implements Serializable {
    ...
    public IngresoProducto(Integer codigo, int codStock) {
        this.codigo = codigo;
